...
mkdir -p ~/.claude/skills/effort
mkdir -p ~/.claude/skills/history
mkdir -p ~/.claude/skills/hype

# Symlink skills
ln -sf "$PACKAGE_DIR/.claude/skills/effort/SKILL.md" ~/.claude/skills/effort/SKILL.md
...
echo "  /effort   - toggle max thinking (permanent ultrathink)"
